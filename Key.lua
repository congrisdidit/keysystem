...
local Config = {
    ...
    ServiceId       = 25984, -- Your PlatoBoost Service ID
    PlatoSecret     = "731c25fa-397d-4aea-800e-5023c5450c77", -- Your PlatoBoost Secret Key

    -- [2] Anti-Bypass / Global Secret Variable
    Secret          = "itsagun", -- This makes the script ONLY run from the key script. Even if they copy the original obfuscated script to bypass the key, they won't be able to!
    
    -- [3] Scripts & Links
    MainScriptURL   = "https://raw.githubusercontent.com/congrisdidit/keysystem/refs/heads/main/script.lua", -- The raw URL  of your main script
    ...
    -- [6] GUI Management
    OldGuiName      = "Ethan Hub Key System", -- Name of the old GUI to destroy if it's already open
    MainGuiName     = "Ethan Hub", -- Name of the main script's GUI to check if it's already executing

    -- [7] Hub Information & UI Text
    HubName         = "Ethan Hub", -- The main title shown at the top of the GUI
    HubDescription  = "Rivals cheats by Ethan" -- The text shown below the title
}
